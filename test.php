...
<body>
      ...
      <div class="row">
        <div class="col-lg-8">
          <div class="main_blog_details">
                ...
                <div class="carousel-inner">
                  <?php foreach ($images as $index => $image): ?>
                    <div class="carousel-item <?php echo $index == 0 ? 'active' : ''; ?>">
                      <img src="../../assets/images/blogs/admin/<?php echo htmlspecialchars($image); ?>" class="d-block w-100" alt="Blog Image">
                    </div>
                  <?php endforeach; ?>
                </div>
            ...
            <?php else: ?>
              <img class="img-fluid" src="../../assets/images/blogs/admin/<?php echo htmlspecialchars($images[0]); ?>" alt="<?php echo htmlspecialchars($blog['title']); ?>">
            <?php endif; ?>
            <a href="#">
            ...
            <!-- Map Section -->
            <div class="h1 pt-5 pb-3 text-success">Get Direction</div>
            <?php if (!empty($blog['latitude']) && !empty($blog['longitude'])): ?>
              <div id="map"></div>
            <?php endif; ?>
          </div>
          ...
          <!-- Events Section -->
    <section id="events" class="py-5 bg-light fade-in k">
        <div class="container">
            <div class="text-center mb-5">
                <h3 class="fs-6 text-uppercase">Upcoming Events</h3>
                <h2 class="display-6 ">Experience the Culture of Nueva Ecija</h2>
                <p class="mb-4 ">Join us in celebrating the vibrant culture and traditions of Nueva Ecija through our curated events.</p>
            </div>
            <div class="row gy-4">
                <!-- Event Item -->
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="card h-100 shadow-sm border-0 event-card" style="border-radius: 20px;">
                        <div class="img-wrapper position-relative">
                            <img src="assets/images/events/OIP.jpg" class="card-img-top" alt="Event 1" style="border-radius: 20px 20px 0 0; object-fit: cover; height: 250px;">
                            <div class="event-date position-absolute top-0 start-0 bg-success text-white p-2 rounded" style="margin: 10px;">
                                <h5 class="mb-0">Aug</h5>
                                <p class="mb-0">23</p>
                            </div>
                        </div>
                        <div class="card-body d-flex flex-column">
                            <h5 class="card-title text-success">Nueva Ecija Harvest Festival</h5>
                            <p class="text-muted">Celebrate the bountiful harvest of Nueva Ecija with traditional music, dance, and food.</p>
                            <a href="#!" class="btn btn-outline-success mt-auto rounded-pill">Learn More</a>
                        </div>
                    </div>
                </div>
                <!-- Event Item -->
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="card h-100 shadow-sm border-0 event-card" style="border-radius: 20px;">
                        <div class="img-wrapper position-relative">
                            <img src="assets/images/events/2.jpg" class="card-img-top" alt="Event 2" style="border-radius: 20px 20px 0 0; object-fit: cover; height: 250px;">
                            <div class="event-date position-absolute top-0 start-0 bg-success text-white p-2 rounded" style="margin: 10px;">
                                <h5 class="mb-0">Sep</h5>
                                <p class="mb-0">15</p>
                            </div>
                        </div>
                        <div class="card-body d-flex flex-column">
                            <h5 class="card-title text-success">Historical Walk of Nueva Ecija</h5>
                            <p class="text-muted">Explore the rich history of Nueva Ecija with guided tours of its most famous landmarks.</p>
                            <a href="#!" class="btn btn-outline-success mt-auto rounded-pill">Learn More</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="card h-100 shadow-sm border-0 event-card" style="border-radius: 20px;">
                        <div class="img-wrapper position-relative">
                            <img src="assets/images/events/events-3.jpg" class="card-img-top" alt="Event 3" style="border-radius: 20px 20px 0 0; object-fit: cover; height: 250px;">
                            <div class="event-date position-absolute top-0 start-0 bg-success text-white p-2 rounded" style="margin: 10px;">
                                <h5 class="mb-0">Oct</h5>
                                <p class="mb-0">09</p>
                            </div>
                        </div>
                        <div class="card-body d-flex flex-column">
                            <h5 class="card-title text-success">Art and Culture Week</h5>
                            <p class="text-muted">Join us for a week-long celebration of the arts, showcasing local talents and cultural performances.</p>
                            <a href="#!" class="btn btn-outline-success mt-auto rounded-pill">Learn More</a>
                        </div>
                    </div>
                </div>
  ...
  <script>
    $(document).ready(function() {
      ...
      <?php if (!empty($blog['latitude']) && !empty($blog['longitude'])): ?>
        var map = L.map('map').setView([<?php echo $blog['latitude']; ?>, <?php echo $blog['longitude']; ?>], 15);
        ...
        var marker = L.marker([<?php echo $blog['latitude']; ?>, <?php echo $blog['longitude']; ?>]).addTo(map);

        marker.bindPopup("<b><?php echo htmlspecialchars($blog['location_name']); ?></b><br><a href='https://www.google.com/maps/dir/?api=1&destination=<?php echo $blog['latitude']; ?>,<?php echo $blog['longitude']; ?>' target='_blank'>Get Directions</a>").openPopup();
      <?php endif; ?>
    });
  </script>
</body>
